...
const translations = {
  en: {
    ...
    landing: {
      ...
      toolsCalculatorLink: "Open the calculator",
      toolsPricingHubTitle: "Explore pricing per model",
    ...
    modelPricing: {
      ...
      pricePerMillionTitle: "Price per 1M tokens",
      peakLabel: "Peak",
      ...
      calculatorLink: "Open the Pricing Calculator",
      relatedTitle: "Related model pricing",
      relatedDesc: "Compare this model against the rest of the lineup.",
      faqTitle: "Frequently Asked Questions",
      pricingNoteBadge: "Pricing notes",
      bestForBadge: "Best for",
      vsBadge: "vs the competition",
    },
  },
  ...
  zh: {
    ...
    landing: {
      ...
      toolsCalculatorDesc:
        "按你的实际用量与模型组合估算月度费用。",
      toolsCalculatorLink: "打开计算器",
      toolsPricingHubTitle: "按模型查看定价",
      qaTitle: "常见问题",
      qaQ1: "我的数据会上传到服务器吗？",
    ...
    modelPricing: {
      ...
      backToHome: "返回首页",
      cta: "估算我的成本",
      pricePerMillionTitle: "每百万 token 价格",
      peakLabel: "高峰",
      offpeakLabel: "闲时",
      inputLabel: "输入",
      outputLabel: "输出",
      ...
      calculatorLink: "打开价格计算器",
      relatedTitle: "相关模型定价",
      relatedDesc: "将该模型与系列其他模型横向对比。",
      faqTitle: "常见问题",
      pricingNoteBadge: "计费说明",
      bestForBadge: "适合场景",
      vsBadge: "与竞品对比",
    },
  },
