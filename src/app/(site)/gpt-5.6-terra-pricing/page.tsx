/** 文件说明：GPT-5.6 Terra 定价 SEO 落地页路由与元数据。 */
...
export function generateMetadata(): Metadata {
  return buildModelPricingMetadata("gpt56Terra", "en");
}

export default function ModelPricingRoute() {
  return (
    <>
      <ModelPricingPage modelKey="gpt56Terra" />
      <ModelPricingContent modelKey="gpt56Terra" />
    </>
  );
}
